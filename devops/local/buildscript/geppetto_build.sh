...
APPLICATION='/ticketsampleapplication7869'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7869-desktop:1.0'
...
helm install --name ticketsampleapplication7869-4621 ./helm
if [ $? -eq 0 ]; then
